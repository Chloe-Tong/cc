...
export default function EpisodicTab({ search }: Props) {
  ...
  return (
    <div className="px-6 py-6 max-w-3xl">
      <p className="text-sm mb-6" style={{ color: '#75956b' }}>
      ...
      <div className="relative pl-8">
        ...
        <div className="absolute left-3 top-2 bottom-2 w-0.5 rounded-full"
          style={{ background: 'linear-gradient(to bottom, #c4983a, #93af8b, transparent)' }} />
          ...
          {episodes.map((m) => (
            <div key={m.id} className="relative">
              ...
              <div className="absolute -left-8 top-4 w-3 h-3 rounded-full"
                style={{ background: '#c4983a', border: '2px solid #1e2118', boxShadow: '1px 1px 0 #1e2118' }} />

              <p className="font-hand text-sm mb-1.5" style={{ color: '#75956b' }}>
